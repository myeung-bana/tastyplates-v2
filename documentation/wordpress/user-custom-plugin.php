...
/*
Plugin Name: User Custom REST API Plugin
Description: A custom REST API plugin for user management.
Version: 1.0
Author: Joshua Algadipe
*/
...
class User_Custom_REST_API extends WP_REST_Controller {
	protected $namespace;
	protected $rest_base;
	protected $meta;
