...
import { GET_ALL_CATEGORIES } from '@/app/graphql/Taxonomies/categoryQueries';
...
export async function GET(request: NextRequest) {
  try {
    ...
    const result = await hasuraQuery(GET_ALL_CATEGORIES, variables);
    ...
    const total = result.data?.restaurant_categories_aggregate?.aggregate?.count || categories.length;
