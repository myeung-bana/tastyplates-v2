...
export const usernameInvalidCharacters = "Username can only contain letters, numbers, underscores (_), and hyphens (-).";
...
export const resetEmailFailed = "Failed to send reset email";