    ...
    return (
        <div className="restaurant-card animate-pulse">
            <div className="restaurant-card__image relative">
                <div className="bg-gray-300 w-full h-[180px] md:h-[222px] rounded-lg" />
            ...
            <div className="restaurant-card__content">
                <div className="restaurant-card__header">
                    <div className="h-4 md:h-4 bg-gray-300 rounded w-3/4 mb-2"></div>
                    <div className="h-4 md:h-4 bg-gray-300 rounded w-1/4"></div>
                </div>
                <div className="restaurant-card__info">
                    <div className="h-3 md:h-3 bg-gray-200 rounded w-5/6 my-1"></div>
                    <div className="h-3 md:h-3 bg-gray-200 rounded w-4/6"></div>
                </div>
                <div className="restaurant-card__tags flex flex-wrap gap-2 mt-2">
                    ...
                    <div className="h-3 md:h-3 bg-gray-200 rounded w-10"></div>
                </div>
            </div>
        </div>
    );
