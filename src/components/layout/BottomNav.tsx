...
const BottomNav: React.FC = () => {
  ...
  return (
    <nav className={`bottom-nav fixed bottom-0 left-0 right-0 z-50 bg-white border-t border-gray-200 safe-area-pb transition-transform duration-300 ease-in-out font-neusans ${
