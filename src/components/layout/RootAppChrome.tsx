...
/**
 * Default app shell: Nhost, session, nav chrome, PWA helpers.
 * Skipped for `/uptime` via middleware + root layout branch.
 */
export default function RootAppChrome({ children }: { children: React.ReactNode }) {
